...
function DrawRightClickMenu()
    ...
    love.graphics.setColor(1,1,1,1)
    love.graphics.rectangle("fill", RightClickMenu.x, RightClickMenu.y, text_width+RIGHT_CLICK_MENU_SPACING*2, (text_height+RIGHT_CLICK_MENU_OPTION_HEIGHT)*#buttons)

    love.graphics.setColor(0,0,0,1)
    love.graphics.setLineWidth(1)
    love.graphics.rectangle("line", RightClickMenu.x+0.5, RightClickMenu.y+0.5, text_width+RIGHT_CLICK_MENU_SPACING*2-1, (text_height+RIGHT_CLICK_MENU_OPTION_HEIGHT)*#buttons-1)

    for i, text in ipairs(buttons) do
        love.graphics.print(text, RightClickMenu.x+RIGHT_CLICK_MENU_SPACING, RightClickMenu.y+RIGHT_CLICK_MENU_OPTION_HEIGHT*0.5+(text_height+RIGHT_CLICK_MENU_OPTION_HEIGHT)*(i-1))

        if i ~= 1 then
            love.graphics.line(RightClickMenu.x, RightClickMenu.y+(text_height+RIGHT_CLICK_MENU_OPTION_HEIGHT)*(i-1), RightClickMenu.x+text_width+RIGHT_CLICK_MENU_SPACING*2, RightClickMenu.y+(text_height+RIGHT_CLICK_MENU_OPTION_HEIGHT)*(i-1))
        end
    end
end